        ...
        <div>
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
                <FormGroup>
                    ...
                    <FormControl>
                        <InputLabel id="nivel-estudios-label">Nivel de estudios tiene el Madre</InputLabel>
                        <Select
                    ...
                    <TextField
                        ...
                        id="ocupacion"
                        name="ocupacion"
                        label="¿A que se dedica el madre? "
                    ...
                    <TextField
                        ...
                        label="numero telefónico del madre"
